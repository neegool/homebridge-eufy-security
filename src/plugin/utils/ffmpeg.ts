...
export class FfmpegProcess extends EventEmitter {
  ...
  protected protectCamera: CameraAccessory;
  private stderrBuffer: string;
  protected stderrLog: string[];

  // Create a new FFmpeg process instance.
  constructor(protectCamera: CameraAccessory, commandLineArgs?: string[], callback?: StreamRequestCallback) {
  ...
  protected prepareProcess(commandLineArgs?: string[], callback?: StreamRequestCallback): void {
    ...
    if (this.isLogging || this.isVerbose || this.platform.config.enableDetailedLogging) {
