...
import { FfmpegRecordingProcess } from '../utils/ffmpeg-record.js';
import { PROTECT_HKSV_MAX_EVENT_ERRORS } from '../settings.js';
import { Logger as TsLogger, ILogObj } from 'tslog';
import { ProtectTimeshiftBuffer } from '../utils/timeshift.js';
...
export class ProtectRecordingDelegate implements CameraRecordingDelegate {
  ...
  private readonly protectCamera: CameraAccessory;
  ...
  constructor(protectCamera: CameraAccessory) {
  ...
  private async startTransmitting(): Promise<boolean> {
    ...
    const isAudioActive = (this.protectCamera.hasFeature('Audio') &&
